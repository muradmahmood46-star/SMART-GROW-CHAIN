...
async def lifespan(app: FastAPI):
    ...
    migrations = [
        ...
        "INSERT INTO site_settings (key, value) VALUES ('level_1_refs_needed', '3') ON CONFLICT (key) DO NOTHING",
        "INSERT INTO site_settings (key, value) VALUES ('level_2_refs_needed', '5') ON CONFLICT (key) DO NOTHING",
        "INSERT INTO site_settings (key, value) VALUES ('level_3_refs_needed', '15') ON CONFLICT (key) DO NOTHING",
