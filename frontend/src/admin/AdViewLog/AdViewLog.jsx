...
export default function AdViewLog({ adViewLog, adLogSearch, setAdLogSearch, searchAdLog }) {
  return (
    <div>
      ...
      <div style={{display:'flex',gap:10,marginBottom:16}}>
        ...
        <button className="sgc-btn-sm" style={{padding:'0 14px',background:'var(--border)',color:'var(--muted)'}} onClick={()=>{ setAdLogSearch(''); }}>Reset</button>
      </div>
