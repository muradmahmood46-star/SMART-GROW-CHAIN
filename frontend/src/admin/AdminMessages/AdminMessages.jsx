    ...
    <div>
      ...
      <div className="sgc-form" style={{maxWidth:480,marginBottom:24}}>
        ...
        <div style={{display:'flex',gap:10}}>
          <button style={{flex:1,padding:'10px',background:'#25d366',border:'none',borderRadius:10,color:'#fff',fontWeight:700,fontSize:13,cursor:'pointer',fontFamily:'var(--font)'}} onClick={async()=>{ await updateSetting('whatsapp_link', whatsappInput); setWhatsappLink(whatsappInput); notify('Saved ✅'); }}>Save</button>
          {whatsappLink&&<button style={{flex:1,padding:'10px',background:'#450a0a',border:'none',borderRadius:10,color:'#fca5a5',fontWeight:700,fontSize:13,cursor:'pointer',fontFamily:'var(--font)'}} onClick={async()=>{ await updateSetting('whatsapp_link', ''); setWhatsappLink(''); setWhatsappInput(''); notify('Removed'); }}>Remove</button>}
        </div>
      ...
      <div className="sgc-form" style={{maxWidth:480,marginBottom:24}}>
        ...
        <button className="sgc-btn-yellow" style={{width:'auto',padding:'10px 24px'}} onClick={async()=>{ await updateSetting('transfer_message', transferMsgInput); setTransferMsg(transferMsgInput); notify('Saved ✅'); }}>Save</button>
      </div>
      ...
      <div className="sgc-form" style={{maxWidth:480,marginBottom:24}}>
        ...
        <button className="sgc-btn-yellow" style={{width:'auto',padding:'10px 24px'}} onClick={async()=>{ await updateSetting('referral_message', referralMsgInput); setReferralMsg(referralMsgInput); notify('Saved ✅'); }}>Save</button>
      ...
      <div className="sgc-form" style={{maxWidth:480,marginBottom:24}}>
        ...
        <button className="sgc-btn-yellow" style={{width:'auto',padding:'10px 24px'}} onClick={async()=>{ await updateSetting('dashboard_message', dashboardMsgInput); setDashboardMsg(dashboardMsgInput); notify('Saved ✅'); }}>Save</button>
      ...
      <div className="sgc-form" style={{maxWidth:480,marginBottom:24}}>
        ...
        <div style={{display:'flex',gap:10,alignItems:'center'}}>
          ...
          <button className="sgc-btn-yellow" style={{width:'auto',padding:'10px 20px',whiteSpace:'nowrap'}} onClick={async()=>{ await updateSetting('registration_bonus', String(regBonusInput)); setRegistrationBonus(parseFloat(regBonusInput)); notify('Saved ✅'); }}>Save</button>
        </div>
      ...
      <div className="sgc-form" style={{maxWidth:480,marginTop:24}}>
        ...
        <button className="sgc-btn-yellow" style={{width:'auto',padding:'10px 24px'}} onClick={async()=>{ await updateSetting('withdrawal_message', withdrawalMsgInput); setWithdrawalMsg(withdrawalMsgInput); notify('Saved ✅'); }}>Save</button>
      ...
      <div className="sgc-form" style={{maxWidth:480,marginTop:24}}>
        ...
        <button className="sgc-btn-yellow" style={{width:'auto',padding:'10px 24px'}} onClick={async()=>{ await updateSetting('advertiser_message', advertiserMsgInput); setAdvertiserMsg(advertiserMsgInput); notify('Saved ✅'); }}>Save</button>
      ...
      <div className="sgc-form" style={{maxWidth:480,marginTop:24}}>
        ...
        <button className="sgc-btn-yellow" style={{width:'auto',padding:'10px 24px'}} onClick={async()=>{ await updateSetting('ad_section_message', adSectionMsgInput); setAdSectionMsg(adSectionMsgInput); notify('Saved ✅'); }}>Save</button>
