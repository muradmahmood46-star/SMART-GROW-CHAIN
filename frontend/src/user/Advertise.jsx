    ...
    <div>
      ...
      {reactivateModalReq && (
        <div className="sgc-modal-overlay" style={{display:'flex',alignItems:'center',justifyContent:'center',zIndex:9999,position:'fixed',top:0,left:0,right:0,bottom:0,background:'rgba(0,0,0,0.82)',backdropFilter:'blur(6px)'}}>
          <div className="sgc-modal fade-up" style={{textAlign:'left',maxWidth:540,width:'92%',maxHeight:'90vh',overflowY:'auto',background:'var(--card)',border:'1px solid var(--border)',borderRadius:20,padding:'28px 24px',boxShadow:'0 20px 50px rgba(0,0,0,0.6)'}}>
