...
export default function Login() {
  ...
  const [faStep, setFaStep]   = useState(false);  // 2FA step
  ...
  return (
    <div style={s.page}>
      <div style={s.card}>
        ...
        <p style={s.sub}>{faStep ? 'Enter your 2FA code' : 'Login to your account'}</p>
        ...
        {!faStep ? (
          ...
          <form onSubmit={handle2FA}>
            <p style={{ color:'#94a3b8', fontSize:13, marginBottom:16 }}>Open Google Authenticator and enter the 6-digit code for your account.</p>
            ...
            <button type="button" onClick={()=>{ setFaStep(false); setFaCode(''); setError(''); }}
